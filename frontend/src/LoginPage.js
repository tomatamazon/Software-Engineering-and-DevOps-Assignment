    ...
    return(
        <div className='login-page-parent'>
            <div className='login-textbox'>
                <Form>
                    <Form.Control style={{ 'text-align': 'center', 'margin-bottom': '3px' }} placeholder='username' onChange={handleUsername} />
                    <Form.Control style={{ 'text-align': 'center' }} placeholder='password' type='password' onChange={handlePassword} />
                </Form>
            </div>
